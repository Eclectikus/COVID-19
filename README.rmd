...
title: "COVID-19"
author: "noSoloDatos"
abstract: "Recopilación y digitalización de los datos oficiales sobre **COVID-19** entre el 5 de marzo y el 5 de junio de 2020" 
date: "2022-12-26"
output:
  github_document:
    toc: true
...
[![License: CC BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by/4.0/deed.es target="_blank") [![Not Maintained](https://img.shields.io/badge/Maintenance%20Level-Not%20Maintained-yellow.svg)](https://gist.github.com/cheerfulstoic/d107229326a01ff0f333a1d3476e068d target="_blank")


:new: Liberado todo el [código - RMarkdown/HTML](https://github.com/Eclectikus/COVID-19/tree/master/code). :christmas_tree:	 Navidades 2022. :christmas_tree:	
